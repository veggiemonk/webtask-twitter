...
cat<<EOF
     ...
     ${bold}./start.sh ${underline}[url]${reset} ${underline}[time]${reset}
        * ${bold}${blue}url${reset}:  (URI), must be escaped,
            This url can be found when installing your script as a webtask.
            To install your webtask: see ${underline}https://github.com/veggiemonk/webtask-twitter#how-to-install-the-webtask-${reset}
     ...
     To run the script every hour :
        ${bold}./start.sh ${underline}https://webtask.... ${blue}3600${reset}
EOF
exit 1
}
